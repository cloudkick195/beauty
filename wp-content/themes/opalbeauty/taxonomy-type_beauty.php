...
<div class="wrap taxonomy-page">
    <form method="GET" id="filter-type_beauty" class="filter-form">
        <div class="custom-select <?php echo (!empty($search_location) ? '':'default-select')?>">
        ...
        <div class="custom-select bg-rating <?php echo (!empty($search_rate) ? '':'default-select')?>">
            <select name="rate" onchange="this.form.submit()" data-text="<?php echo empty($search_rate) ? __('Rate', 'opalbeauty') : ''?>">
                <option class="s" value="" selected><?php _e('Rate', 'opalbeauty')?></option>
               
                <option class="s0" value="5" <?php echo $search_rate == '5' ? 'selected' : ''?>>5</option>
                ...
                <option class="s5" value="6" <?php echo $search_rate == '6' ? 'selected' : ''?>><?php _e('No rate', 'opalbeauty')?></option>
            </select>
        </div>
        ...
        if(l > 0){
            for (i = 0; i < l; i++) {
                ...
                if(!selElmnt.dataset.text){
                    ...
                    a.setAttribute("class", "select-selected hiden-text s" + selElmnt.options[selElmnt.selectedIndex].value);
                }else{
                    ...
                    c.addEventListener("click", function(e) {
                        ...
                        for (i = 0; i < sl; i++) {
                            if (s.options[i].innerHTML == this.innerHTML) {
                                ...
                                h.classList.value = 'select-selected hiden-text ';
