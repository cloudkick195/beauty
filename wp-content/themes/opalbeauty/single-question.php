...
<div class="wrap question-archive">
    <div class="post-box">
        <div class="post img-des">
            ...
            ?>
            <div class="img"><a class="thumb-link" href="<?php echo get_author_posts_url($post_author).'?post=question';?>"
                    title="<?php the_title_attribute()?>">
                    <?php echo $img_avatar?>
                </a></div>
            <div class="des">
                <h5 class="box-title">
                    <a href="<?php echo get_author_posts_url($post_author).'?post=question';?>"?><?php the_author()?></a>
                    <?php  
            ...
            <div class="meta-span">
                <div class="like-comment">
                    ...
                    <span class="like-comment-like <?php echo $user_like['liked'] ? 'active' : ''?>"  data-id="<?php the_ID()?>">
                        ...
                        <span><?php echo $user_like['count']?></span> <?php _e('liked', 'opalbeauty')?>
                    </span>
