...
$postOther = count_post_type('question');?>
<div class="nav-author">
    <a
        href="<?php echo get_author_posts_url($user_id)?>?post=question"><?php _e('Question', 'opalbeauty'); echo ' ('.$postOther.')'?></a>
    <a class="active"
        href="<?php echo get_author_posts_url($user_id)?>?post=review"><?php _e('Review', 'opalbeauty'); echo ' ('.$countPost.')'?></a>
</div>
<a class="author-create-action" href="<?php create_url('post-review')?>">
                ...
                ?>
                    ...
                    <div class="des">
                        <h5><a class="box-title" href="<?php echo get_author_posts_url($post_author) ?>"
                                ...
                                <?php  
                            $author_post = get_author_question(get_the_ID(), 'review');
                            if(count($author_post['post']) > 0):?>
                            <div class="action-question">
                                <span>...</span>
                                <div class="popup">
                                    <a href="<?php create_url('edit-review?qid='.get_the_ID())?>"><?php _e('Edit', 'opalbeauty');?></a>
                                    <a class="popup-btn" href="#"><?php _e('Delete', 'opalbeauty');?></a>
                                </div>
                            </div>
                            <div class="popup-box review-popup-box">
                                <div class="box">
