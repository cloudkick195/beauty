...
<section class="banner-slider home-slider-banner">
    <?php the_content();?>
</section>
<section class="user-section wrap user-section-box">
    <div class="img-des">
        <div class="img">
            <?php 
                $img_avatar = '
...
<div class="wrap">
    ...
    <div class="slider-section slider2 news-section">
        <div class="post-box2 owl-carousel post-thumb-full">
        <?php  
            $args = array(
                'post_type'    =>    'post',
                'posts_per_page' => 3,
            ...
            if ( $the_query->have_posts() ) :
                while ( $the_query->have_posts() ) : $the_query->the_post();?>
            <div class="post">
                <a class="thumb-link thumb-floating" href="<?php the_permalink() ?>"
                    title="<?php the_title_attribute()?>"><?php the_post_thumbnail();?></a>
                <div>
                <div class="meta-span">
