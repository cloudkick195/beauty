...
<main class="user-page wrap account-page">
    <section class="form-section">
        <form id="form-account-update" class="opal-forms opal-forms2">
            ...
            <div class="field number-field age">
                <label for="age"><?php _e('Age', 'opalbeauty')?></label>
                <div>
                    <input class="input-form require" name="age" type="number" value="<?php echo $user['age']?>">
                    <!-- <p class="mess"></p> -->
                </div>
            ...
            <div class="change-pass-box">
                <a href="#" class="change-pass change-pass-action"><?php _e('Change password', 'opalbeauty')?></a>
            ...
            <div class="change-pass-box">
                <a href="#" class="change-pass"><?php _e('Change password', 'opalbeauty')?></a>
                <div class="field password-field password">
                    <label for="password">
                        <?php _e('Password', 'opalbeauty')?>
                    </label>
